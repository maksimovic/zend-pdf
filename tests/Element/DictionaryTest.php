...
class Zend_Pdf_Element_DictionaryTest extends TestCase
{
    ...
    public function testPDFDictionaryBadInput1()
    {
        ...
        $this->expectExceptionMessageMatches('/must be an array/i');
    ...
    {
        $this->expectException(Zend_Pdf_Exception::class);
        $this->expectExceptionMessageMatches('/must be Zend_Pdf_Element/i');
        $srcArray = array();
        $srcArray['Bool'] = new Zend_Pdf_Element_Boolean(false);
        $srcArray['Number'] = new Zend_Pdf_Element_Numeric(100.426);
        $srcArray['Name'] = new Zend_Pdf_Element_Name('MyName');
    ...
    {
        $this->expectException(Zend_Pdf_Exception::class);
        $this->expectExceptionMessageMatches('/keys must be strings/i');
        $srcArray = array();
        $srcArray['Bool'] = new Zend_Pdf_Element_Boolean(false);
        $srcArray['Number'] = new Zend_Pdf_Element_Numeric(100.426);
        $srcArray['Name'] = new Zend_Pdf_Element_Name('MyName');
